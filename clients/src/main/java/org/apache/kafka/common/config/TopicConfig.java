...
public class TopicConfig {
    ...
    public static final String COMPRESSION_GZIP_LEVEL_DOC = "The compression level which Gzip uses. The greater the level is, the better the compression ratio but slower speed. "
    ...
    public static final String COMPRESSION_LZ4_LEVEL_DOC = "The compression level which LZ4 uses. The greater the level is, the better the compression ratio but slower speed. "
    ...
    public static final String COMPRESSION_ZSTD_LEVEL_DOC = "The compression level which LZ4 uses. The greater the level is, the better the compression ratio but slower speed. "
